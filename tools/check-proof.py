"""Check final committed Git blobs against the local selector-upgrade manifest."""
import hashlib
import json
import subprocess
...
record = json.loads((root / "evidence/selector-upgrade.json").read_text(encoding="utf-8"))
